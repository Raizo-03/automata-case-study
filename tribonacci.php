...
<div class="flex flex-col items-center justify-center min-h-screen px-10">
    <div class="text-center mb-12 animate-[fadeIn_1s_ease-out]">
        <h1 class="text-6xl title-text mb-8">Tribonacci</h1>
    </div>
    ...
    <div class="flex flex-row w-full max-w-7xl space-x-10">
        ...
        <h2 class="text-3xl text-cyan-400 mb-4">What is the Tribonacci Sequence?</h2>
        <p class="text-lg text-white">
            The Tribonacci sequence is like the Fibonacci sequence, but each term is the sum of the three preceding terms. It typically starts with 0, 0, 1.
        </p>
        ...
        <!-- Right Box: Input -->
        <div class="w-1/2 p-8 bg-black bg-opacity-70 border border-cyan-400 rounded-2xl shadow-xl backdrop-blur animate-[fadeIn_1s_ease-out]">
            <h2 class="text-3xl text-cyan-400 mb-4">Generate Tribonacci</h2>
            <form method="post" class="flex flex-col space-y-4">
                <input type="number" name="num" placeholder="Enter number of terms (min 4)"
        ...
        <div class="text-white text-xl">
            <?php if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if ($error) {
                    ...
                    echo "<span class='text-cyan-300'>Tribonacci Series up to $num terms:</span><br><br>";
